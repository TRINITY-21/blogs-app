# Generated by Django 3.2.14 on 2022-08-08 16:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('story', '0010_featuredpage'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='secondarytag',
            options={'verbose_name': 'Secondary Tags', 'verbose_name_plural': 'Secondary Tags (DO NOT EDIT)'},
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='custom_form_field', to='story.storypage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
